...
public class Round {
     ...
     *
     * @TODO maybe a collection of players and for each one give 2 cards can be
     * interesting to generalize the operations in case of multiples players
     */
    ...
    public void processus() {
        ...
        this.choice();
        //@TODO need te bot to play as well
